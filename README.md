...
| Industry assurance | Versioned crosswalks for 19 verification, lifecycle, maturity, weakness, adversary, AI, quality, and architecture catalogs; repository-scoped control assessment with OSCAL 1.1.2 export; eight governed benchmark families with replay-protected scorecards, stratified accuracy, and regression deltas; CycloneDX/OpenVEX/CSAF VEX interoperability |
