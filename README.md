...
| Accuracy controls | Multi-axis finding validation with proof-bound reproduction, executed framework model canaries, OpenAPI/auth behavior drift, declared allow/deny/tenant tests, exact advisory-function calls, static dependency cycles/fan-out, cognitive complexity, bounded Git temporal coupling, and generated profile execution truth |
