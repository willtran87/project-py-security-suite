...
| Industry assurance | Versioned crosswalks for 39 verification, testing, lifecycle, control, weakness, adversary, AI, cloud, quality, and architecture references; evidence-backed control and procedure assessment; source-retained CVSS v4 and SSVC prioritization; an official-schema-valid OSCAL 1.2.2 seven-model lifecycle package; nine governed benchmark families with reproducibility contracts, confidence intervals, and regression deltas; CycloneDX 1.7/OpenVEX/CSAF/SCAP interoperability |
...
flowchart LR
    ...
    subgraph Boundary["Externally isolated execution boundary"]
        ...
        Benchmarks["Pinned OWASP/NIST/LLM/holdout corpora"] --> BenchmarkLane["Disposable benchmark lane"]
        BenchmarkLane --> Scorecards["Replay-protected scorecards + deltas"]
        Scorecards --> Policy
