...
| Industry assurance | 635 versioned references, 66 quarantined watch items, 215 selectable profiles, 262 governed benchmark families, 192 maintained adapters, eleven typed protocols, and 96 suite-owned semantic integrations. Coverage includes application, supply-chain, identity, AI/HPC, ransomware recovery, media sanitization, OT backup and remote access, IEC 62443 provider evaluation, crisis exercises, enterprise ICT risk aggregation, standards-crosswalk semantics, LNG and EV charging, medical devices and global GxP records, healthcare and CJIS operations, semiconductor fabrication, water and wastewater, pipelines and gas SCADA, NG911/P25 public-safety communications, multimodal transit, emergency incident coordination, building automation, process SIS, industrial robotics, data-centre facilities, automotive process capability, physical AI/autonomy, firmware and hardware trust, Kubernetes-native admission, payment PIN/POI/HSM/3DS, regional financial resilience, critical C/C++, confidential-computing attestation, voting systems, NSS/DoD authorization readiness, operational zero trust, airborne and continuing-airworthiness systems, CCSDS communications and ECSS space-software product assurance, secure inter-organization sharing and assessor competence, accredited laboratories, maritime operations, nuclear/rail/space safety-security, stateful smart contracts, longitudinal DevSecOps/test maturity, detection-product calibration, formal-method disagreement, empirical outcome calibration, cloud, privacy, resilience and regulated sectors. Every active benchmark is subject-bound, independently replayed, negative-tested and isolated; research datasets, drafts, alpha material, licensed content and external-certification boundaries remain explicit. |
...
flowchart LR
    ...
    subgraph Boundary["Externally isolated execution boundary"]
        ...
        Benchmarks["262 pinned benchmark families<br/>application | identity | AI | safety | resilience | operations | calibration"] --> BenchmarkLane["192 maintained benchmark adapters<br/>authorized disposable/external lanes<br/>11 typed scoring protocols"]
        BenchmarkLane --> ResilienceLanes["Recovery + sanitization + OT + crisis<br/>provider evaluation + ICT risk + crosswalk + LNG/EV"]
        ResilienceLanes --> SemanticGate["96 suite-owned semantic integrations<br/>source + subject binding | domain oracles<br/>negative controls + independent replay"]
        SemanticGate --> Scorecards["Replay-protected scorecards + deltas"]
        Scorecards --> Policy
        Standards["Versioned standards + repository controls"] --> ControlAssessment["Evidence assessment + OSCAL"]
        ControlAssessment --> Policy
