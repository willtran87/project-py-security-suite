...
`.artifacts/final-self-scan-v20`. It includes:
...
The source test suite currently records 204 passing tests and one platform-
...
coverage is 80.05%, so the repository-wide 80% policy gate passes. The report
