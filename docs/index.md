...
| Static risk routes | [1.0](../src/py_security_suite/schemas/risk-paths.schema.json) | Bounded entry-point routes to findings and review-worthy sensitive sinks with runtime, validation, ownership, shared control-point convergence, owner queues, and explicit unrouted-target context |
