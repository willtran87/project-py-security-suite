...
`.artifacts/final-self-scan-v68`. It includes:
...
The source test suite currently records 278 passing tests and one platform-
...
coverage is 92.06%, and branch coverage is 84.73%, so both measures pass the
