...
`.artifacts/final-self-scan-v46`. It includes:
...
The source test suite currently records 256 passing tests and one platform-
...
coverage is 91.58%, and branch coverage is 83.78%, so both measures pass the
