...
| Sensitive-data exposure | [1.2](../src/py_security_suite/schemas/data-exposure-1.2.schema.json) | CWE-grounded source-to-sink findings, recursive monorepo SDK discovery, local data-class propagation, trust-boundary and protection context, prioritized review surfaces, capture-configuration review, and structural relevance; 1.1 and 1.0 remain bundled |
