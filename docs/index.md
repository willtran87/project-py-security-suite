...
`.artifacts/final-self-scan-v44`. It includes:
...
The source test suite currently records 255 passing tests and one platform-
...
coverage is 91.50%, and branch coverage is 83.65%, so both measures pass the
