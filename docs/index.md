...
`.artifacts/final-self-scan-v71`. It includes:
...
The source test suite currently records 282 passing tests and one platform-
...
coverage is 92.51%, and branch coverage is 85.63%, so both measures pass the
