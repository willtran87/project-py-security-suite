...
| Protected production benchmark | Workflow-enforced schema 2.0 authority, trusted time, replay protection, at least 200 labels, 80 TP, 80 TN, three engines, and 20 labels per required engine; unavailable until the independent environment supplies its governed corpus |
...
| Application contract analysis | [1.2](../src/py_security_suite/schemas/application-contract-analysis-1.2.schema.json) | Code/OpenAPI route and constraint drift, authorization regression, source-bound passing behavioral tests, machine-actionable scenario manifests, relative-import/class-wrapper reachability, and exact advisory-function AST calls; [1.1](../src/py_security_suite/schemas/application-contract-analysis-1.1.schema.json) and [1.0](../src/py_security_suite/schemas/application-contract-analysis-1.0.schema.json) remain bundled |
| Code health | [1.2](../src/py_security_suite/schemas/code-health-1.2.schema.json) | Policy-calibrated complexity, size, nesting, call coupling, class responsibilities and cohesion, swallowed broad exceptions, async blocking, mutable globals, parameter coupling, exact duplicate ASTs, and semantic clones; [1.1](../src/py_security_suite/schemas/code-health-1.1.schema.json) and [1.0](../src/py_security_suite/schemas/code-health-1.0.schema.json) remain bundled |
| Static architecture | [1.2](../src/py_security_suite/schemas/static-architecture-1.2.schema.json) | Policy-calibrated local module graph, syntactic symbol-call edges, decorator entry points, literal/unresolved dynamic imports, declared layer and forbidden-edge enforcement, cycles, fan-out, hubs, instability, and baseline regressions; [1.1](../src/py_security_suite/schemas/static-architecture-1.1.schema.json) and [1.0](../src/py_security_suite/schemas/static-architecture-1.0.schema.json) remain bundled |
