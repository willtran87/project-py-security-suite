...
`.artifacts/final-self-scan-v69`. It includes:
...
The source test suite currently records 280 passing tests and one platform-
...
coverage is 92.32%, and branch coverage is 85.25%, so both measures pass the
