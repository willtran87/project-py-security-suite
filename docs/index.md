...
`.artifacts/final-self-scan-v79`. It includes:
...
- digest-bound scanner trust-remediation actions;
...
coverage is 92.78%, and branch coverage is 86.17%, so both measures pass the
