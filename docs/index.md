...
| Sensitive-data exposure | [1.1](../src/py_security_suite/schemas/data-exposure-1.1.schema.json) | CWE-grounded source-to-sink findings, recursive monorepo SDK discovery, capture-configuration review, sanitizer evidence, and structural relevance; 1.0 remains bundled |
