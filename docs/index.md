...
`.artifacts/final-self-scan-v95`. It includes:
...
The source test suite currently records 296 passing tests and one platform-
...
coverage is 92.99%, and branch coverage is 86.55%, so both measures pass the
