...
`.artifacts/final-self-scan-v34`. It includes:
...
The source test suite currently records 252 passing tests and one platform-
...
coverage is 91.07%, and branch coverage is 83.03%, so both measures pass the
