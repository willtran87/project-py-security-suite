...
`.artifacts/final-self-scan-v48`. It includes:
...
The source test suite currently records 258 passing tests and one platform-
...
coverage is 91.64%, and branch coverage is 83.87%, so both measures pass the
