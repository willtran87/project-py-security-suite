...
| Application contract analysis | [1.1](../src/py_security_suite/schemas/application-contract-analysis-1.1.schema.json) | Code/OpenAPI route and constraint drift, authorization regression, source-bound passing behavioral tests, generated security scenarios, exact advisory-function AST calls, and bounded wrapper-to-handler chains; [1.0](../src/py_security_suite/schemas/application-contract-analysis-1.0.schema.json) remains bundled |
| Code health | [1.1](../src/py_security_suite/schemas/code-health-1.1.schema.json) | Policy-calibrated cognitive complexity, function/class size, nesting, call coupling, class responsibilities, parameter coupling, exact duplicate ASTs, and identifier/literal-normalized semantic clones; [1.0](../src/py_security_suite/schemas/code-health-1.0.schema.json) remains bundled |
| Static architecture | [1.1](../src/py_security_suite/schemas/static-architecture-1.1.schema.json) | Policy-calibrated local Python import graph, declared layer and forbidden-edge enforcement, dependency cycles, fan-out, high-degree hubs, instability, stable-to-unstable edges, and optional baseline edge regressions; [1.0](../src/py_security_suite/schemas/static-architecture-1.0.schema.json) remains bundled |
