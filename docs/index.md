...
`.artifacts/final-self-scan-v64`. It includes:
...
The source test suite currently records 277 passing tests and one platform-
...
coverage is 92.03%, and branch coverage is 84.63%, so both measures pass the
