...
`.artifacts/final-self-scan-v89`. It includes:
...
The source test suite currently records 288 passing tests and one platform-
...
coverage is 92.88%, and branch coverage is 86.34%, so both measures pass the
