...
`.artifacts/final-self-scan-v57`. It includes:
...
The source test suite currently records 270 passing tests and one platform-
...
coverage is 91.92%, and branch coverage is 84.35%, so both measures pass the
