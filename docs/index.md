...
`.artifacts/final-self-scan-v41`. It includes:
...
The source test suite currently records 254 passing tests and one platform-
...
coverage is 91.42%, and branch coverage is 83.44%, so both measures pass the
