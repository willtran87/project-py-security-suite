...
`.artifacts/final-self-scan-v75`. It includes:
...
The source test suite currently records 283 passing tests and one platform-
...
coverage is 92.63%, and branch coverage is 85.90%, so both measures pass the
