...
| Industry benchmark registry and regression | Yes; active targets use disposable companion lanes | Pinned inputs, signed acceptance, source/subject binding, independent replay, deterministic resource budgets, shell-free OCI execution, negative controls and domain-specific claim schemas | 262 families, 192 maintained adapters, eleven protocols and 96 semantic integrations spanning application, identity, AI/HPC, ransomware recovery, media sanitization, OT recovery, crisis exercises, ICT risk aggregation, crosswalk semantics, LNG/EV, semiconductor, water/wastewater, NG911/P25, global GxP, transit, incident coordination, pipeline and gas SCADA, CJIS, Automotive SPICE, process SIS, building automation, robotics, data-centre facilities, firmware/device integrity, Kubernetes admission, payment security, regional finance, ECSS/CCSDS space assurance, secure sharing and competence, medical and healthcare operations, autonomy, critical code, confidential computing, voting, NSS/DoD, zero trust, laboratories, maritime, formal methods, empirical calibration, safety sectors, smart contracts, DevSecOps maturity, detection, supply chain and architecture |
| Standards controls, procedures, prioritization, and OSCAL | Yes | Strict policy 1.3, fail-closed catalog integrity, explicit authorization, signed publisher observations, human promotion, assessor credentials and bounded certification claims | 635-reference crosswalk, 66-item watchlist and 215 selectable profiles; seven OSCAL 1.2.2 lifecycle models; drafts, research corpora, alpha material and licensed content cannot silently become normative |
