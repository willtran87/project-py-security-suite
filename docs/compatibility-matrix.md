...
| Industry benchmark registry and regression | Yes; external vulnerable targets use disposable companion lanes | Pinned corpus digests and revisions, approved protocol-specific acceptance criteria, subject-bound Ed25519 evidence, consumed replay receipts, validated time, digest-pinned executables, shell-free bounded execution, native read-only/capability-free/no-network OCI mode, signed SBOM/provenance, and negative controls | 124 families spanning OWASP/NIST/LLM/AI/identity/crypto/polyglot/IaC/container/SBOM/SCITT/fuzzing/agentic/architecture/API/telemetry/resilience/STIG/OT/forensics/accessibility, ISO 15026/SACM assurance cases, IEEE 1012 V&V, CMVP and ISO cryptographic modules, biometric PAD, service management, and ISO 17043 proficiency testing; eleven executable scoring protocols and 35 maintained adapter specifications |
| Standards controls, procedures, prioritization, and OSCAL | Yes | Strict policy 1.2 selecting bounded assurance packs or naming custom controls/procedures, complete evidence, explicit execution authorization, quarantined HTTPS publisher observations, signed snapshots, JSON/XML/HTML/PDF/text semantic change analysis, affected-control mapping, human promotion approval, verified assessor credentials, and source-provided prioritization data; policy 1.0/1.1 remain readable | 358-reference crosswalk plus publisher monitor, lifecycle ledger, and publication watchlist; 104 general and conditional assurance packs; governed lifecycle, structured assurance-case, integrity V&V, audit, evaluator, cryptographic-module, biometric, service-management, firmware/TPM/DICE, differential-privacy, quality, risk, TLS, reproducible-build, architecture, maturity, interoperability, and external-conformity evidence; CVSS v4/SSVC without fabricated scores; 124 benchmark contracts with 35 maintained adapters and 11 scoring protocols; and seven official-schema-valid OSCAL 1.2.2 lifecycle models |
