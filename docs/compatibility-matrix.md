...
| Industry benchmark registry and regression | Yes; external vulnerable targets use disposable companion lanes | Pinned corpus digests and revisions, approved authority, replay protection, validated time, verified report checksum, complete confusion matrix, qualified runner/target/toolset/oracle/environment/isolation identities for organization corpora, and optional prior scorecard | 18 OWASP/NIST/LLM/AI/Python/IaC/container/secrets/SBOM/malicious-package/fuzzing/agentic/architecture families, per-family runner contracts, Wilson confidence intervals, Youden's J, threshold decisions, and comparable regression deltas |
| Standards controls, procedures, prioritization, and OSCAL | Yes | Strict policy 1.2 selecting bounded assurance packs or naming custom controls/procedures, complete evidence, explicit execution authorization, and source-provided prioritization data; policy 1.0/1.1 remain readable | 58-reference crosswalk; nine enterprise/privacy/PSIRT/supply-chain/AI/regulatory assurance packs; control and procedure outcomes; CVSS v4/SSVC without fabricated scores; and seven official-schema-valid OSCAL 1.2.2 lifecycle models |
