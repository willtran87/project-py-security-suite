...
- the separately generated branch-coverage evidence records 91.50% combined
  line-and-branch coverage and 83.65% branch coverage, satisfying both 80%
  repository gates with no per-file hotspots; JUnit records 255 passing tests,
