...
flowchart LR
    ...
    subgraph Boundary["Enterprise egress-denied execution boundary"]
        ...
        Standards["663 versioned standards references + 233 assurance packs<br/>deterministic catalog export + verified source-manifest compiler<br/>71-item publisher quarantine + signed promotion"]
        Benchmarks["282 governed benchmark families + 212 maintained adapters<br/>application/identity/AI/safety/resilience/operations/calibration/repository truth<br/>repeated statistical fuzzing + temporal calibration<br/>exact equal-tail/mean statistics + full SLSA materials"]
        ExtensionEvidence["116 suite-owned semantic integrations<br/>strict JSON + source/subject binding<br/>ETSI AI lifecycle | agentic containment | FIASSE | NSA MCP<br/>CIS cloud/Docker | GenAI red team | AI Verify | CHECK | AIUC-1 | CSA IoT<br/>C2M2 | FINOS CCC | NCSC CRT | PRAM | ITIL 4 | OpenCRE/Gemara | CBEST | OCP S.A.F.E.<br/>IEC-provider | crosswalk/LNG-EV | independent replay + domain negative cases"]
