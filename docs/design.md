...
- the separately generated branch-coverage evidence records 91.48% combined
  line-and-branch coverage and 83.62% branch coverage, satisfying both 80%
  repository gates with no per-file hotspots; JUnit records 254 passing tests,
