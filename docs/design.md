...
flowchart LR
    ...
    subgraph Boundary["Enterprise egress-denied execution boundary"]
        ...
        Standards["58 versioned standards references<br/>9 selectable assurance packs"]
        Benchmarks["18 pinned benchmark families<br/>qualified execution + confidence + delta"]
