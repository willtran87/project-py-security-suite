...
_ARTIFACT_SCHEMAS = {
    ...
    "application-contract-analysis.json": "application-contract-analysis-1.1.schema.json",
    ...
    "code-health.json": "code-health-1.1.schema.json",
    ...
    "static-architecture.json": "static-architecture-1.1.schema.json",
