...
_ARTIFACT_SCHEMAS = {
    ...
    "application-contract-analysis.json": "application-contract-analysis-1.0.schema.json",
    ...
    "code-health.json": "code-health-1.0.schema.json",
    ...
    "static-architecture.json": "static-architecture-1.0.schema.json",
