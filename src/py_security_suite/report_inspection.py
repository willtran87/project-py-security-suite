...
BUNDLED_SCHEMA_RESOURCES = {
    ...
    "application-contract-analysis-1.3": "application-contract-analysis-1.3.schema.json",
    ...
    "code-health-1.3": "code-health-1.3.schema.json",
    "code-health-1.4": "code-health-1.4.schema.json",
    ...
    "static-architecture-1.3": "static-architecture-1.3.schema.json",
    "static-architecture-1.4": "static-architecture-1.4.schema.json",
    "boundary-graph-1.0": "boundary-graph-1.0.schema.json",
    "benchmark-delta-1.0": "benchmark-delta-1.0.schema.json",
    "benchmark-registry-1.0": "benchmark-registry-1.0.schema.json",
    "benchmark-scorecard-1.0": "benchmark-scorecard-1.0.schema.json",
    "benchmark-adapter-manifest-1.0": "benchmark-adapter-manifest-1.0.schema.json",
    "benchmark-adapter-manifest-1.1": "benchmark-adapter-manifest-1.1.schema.json",
    "benchmark-adapter-manifest-1.2": "benchmark-adapter-manifest-1.2.schema.json",
    "benchmark-preparation-request-1.0": "benchmark-preparation-request-1.0.schema.json",
    "benchmark-attestation-1.1": "benchmark-attestation-1.1.schema.json",
    "benchmark-attestation-1.2": "benchmark-attestation-1.2.schema.json",
    "benchmark-authority-trust-policy-1.0": "benchmark-authority-trust-policy-1.0.schema.json",
    "benchmark-authority-trust-policy-1.1": "benchmark-authority-trust-policy-1.1.schema.json",
    "benchmark-execution-receipt-1.0": "benchmark-execution-receipt-1.0.schema.json",
    "benchmark-execution-receipt-1.1": "benchmark-execution-receipt-1.1.schema.json",
    "benchmark-execution-receipt-1.2": "benchmark-execution-receipt-1.2.schema.json",
    "benchmark-power-analysis-1.1": "benchmark-power-analysis-1.1.schema.json",
    "benchmark-power-analysis-1.2": "benchmark-power-analysis-1.2.schema.json",
    "benchmark-leakage-analysis-1.1": "benchmark-leakage-analysis-1.1.schema.json",
    "benchmark-leakage-analysis-1.2": "benchmark-leakage-analysis-1.2.schema.json",
    "benchmark-duplicate-analysis-1.1": "benchmark-duplicate-analysis-1.1.schema.json",
    "benchmark-duplicate-analysis-1.2": "benchmark-duplicate-analysis-1.2.schema.json",
    "benchmark-contamination-analysis-1.1": "benchmark-contamination-analysis-1.1.schema.json",
    "benchmark-contamination-analysis-1.2": "benchmark-contamination-analysis-1.2.schema.json",
    "benchmark-semantic-records-1.2": "benchmark-semantic-records-1.2.schema.json",
    "benchmark-environment-capture-1.0": "benchmark-environment-capture-1.0.schema.json",
    "benchmark-replay-intent-1.0": "benchmark-replay-intent-1.0.schema.json",
    "benchmark-replay-checkpoint-1.0": "benchmark-replay-checkpoint-1.0.schema.json",
    "benchmark-security-event-record-1.0": "benchmark-security-event-record-1.0.schema.json",
    "benchmark-security-event-record-1.1": "benchmark-security-event-record-1.1.schema.json",
    "benchmark-security-event-anchor-1.0": "benchmark-security-event-anchor-1.0.schema.json",
    ...
    "industry-assurance-1.0": "industry-assurance-1.0.schema.json",
    "industry-assurance-policy-1.0": "industry-assurance-policy-1.0.schema.json",
    "industry-assurance-policy-1.1": "industry-assurance-policy-1.1.schema.json",
    "industry-assurance-policy-1.2": "industry-assurance-policy-1.2.schema.json",
    "industry-assurance-policy-1.3": "industry-assurance-policy-1.3.schema.json",
    "llm-adversarial-plan-1.0": "llm-adversarial-plan-1.0.schema.json",
    "llm-adversarial-policy-1.0": "llm-adversarial-policy-1.0.schema.json",
    "llm-adversarial-proposal-1.0": "llm-adversarial-proposal-1.0.schema.json",
    "oscal-model-1.2.2": "oscal-model-1.2.2.schema.json",
    "procedure-assessment-1.0": "procedure-assessment-1.0.schema.json",
    "standardized-prioritization-1.0": "standardized-prioritization-1.0.schema.json",
    ...
    "standards-crosswalk-1.0": "standards-crosswalk-1.0.schema.json",
    "standards-source-manifest-1.0": "standards-source-manifest-1.0.schema.json",
    "standards-baseline-inventory-1.0": "standards-baseline-inventory-1.0.schema.json",
    "standards-monitor-report-1.0": "standards-monitor-report-1.0.schema.json",
    "standards-monitor-verification-1.0": "standards-monitor-verification-1.0.schema.json",
